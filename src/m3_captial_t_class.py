...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        self.p1 = rg.Point(intersection_center.x - letter_thickness / 2, intersection_center.y - letter_thickness / 2)
        self.p2 = rg.Point(intersection_center.x + letter_thickness / 2, intersection_center.y +
                           (height - (letter_thickness / 2)))
        self.p3 = rg.Point(intersection_center.x - self.width, intersection_center.y - letter_thickness / 2)
        self.p4 = rg.Point(intersection_center.x + self.width, intersection_center.y + letter_thickness / 2)
        self.h_rect = rg.Rectangle(self.p3, self.p4)
        self.v_rect = rg.Rectangle(self.p1, self.p2)
    ...
    def set_colors(self, fill_color, outline_color):
        ...
        self.h_rect.fill_color = outline_color
        self.h_rect.outline_color = outline_color
        self.v_rect.fill_color = outline_color
